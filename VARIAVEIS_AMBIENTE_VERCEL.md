...
Adicione estas variáveis no Vercel **ANTES** de fazer deploy!
...
5. Para cada variável, marque: ✅ **Production**, ✅ **Preview**, ✅ **Development**
...
```
(ou o domínio que você vai usar)
...
Marque cada variável conforme adiciona:
...
- [ ] VITE_RESEND_API_KEY (opcional)

**Todas devem ter: ✅ Production, ✅ Preview, ✅ Development**
