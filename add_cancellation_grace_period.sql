-- ========================================
-- 🔧 SCRIPT: ADICIONAR PERÍODO DE CARÊNCIA PARA CANCELAMENTO DE PLANOS
-- ========================================
-- Este script adiciona a funcionalidade de cancelamento com período de carência
-- Quando um usuário cancela um plano pago, ele continua tendo acesso até o fim do período pago

-- 1️⃣ ADICIONAR COLUNAS NA TABELA user_subscriptions
...
-- 3️⃣ CRIAR FUNÇÃO PARA CALCULAR DATA DE EXPIRAÇÃO
...
-- 4️⃣ CRIAR FUNÇÃO PARA CANCELAR PLANO COM PERÍODO DE CARÊNCIA
...
-- 5️⃣ CRIAR FUNÇÃO PARA REATIVAR PLANO CANCELADO
...
-- 6️⃣ CRIAR FUNÇÃO PARA EXPIRAR ASSINATURAS CANCELADAS (PARA CRON JOB)
...
-- 7️⃣ CRIAR FUNÇÃO PARA VERIFICAR SE USUÁRIO JÁ USOU PLANO FREE
...
-- 8️⃣ CRIAR FUNÇÃO PARA OBTER STATUS DETALHADO DA ASSINATURA
...
-- 9️⃣ CRIAR ÍNDICES PARA MELHOR PERFORMANCE
