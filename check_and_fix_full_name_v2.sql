-- Script para verificar estruturas e corrigir full_name (CORRIGIDO)
...
-- 3. Verificar dados em profiles_v2 (usando user_id em vez de id)
SELECT * FROM profiles_v2 WHERE user_id = 'YNTB2V3606WPxV0zlZxLQNV1tCm1';

-- 4. Verificar dados em user_profiles
