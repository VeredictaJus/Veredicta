-- Script COMPLETO: Criar tabelas + Inserir planos + Adicionar assinaturas
...
-- 2. Criar tabela user_payment_cards se não existir
...
-- 3. Criar tabela user_settings se não existir
...
-- 4. Limpar e inserir os planos corretos
...
-- 5. Adicionar assinatura FREE para todos os usuários que não têm
