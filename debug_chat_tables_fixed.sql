-- Script corrigido para debugar problemas com as tabelas de chat
...
-- 6. Verificar conversas existentes (apenas campos que existem)
SELECT 
...
-- 7. Verificar participantes existentes (apenas campos que existem)
SELECT 
...
-- 8. Verificar mensagens existentes (apenas campos que existem)
SELECT 
