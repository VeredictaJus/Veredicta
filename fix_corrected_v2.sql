-- SOLUÇÃO CORRIGIDA - Usando apenas colunas existentes
...
-- 3. CRIAR funções usando apenas colunas que existem
...
BEGIN
    ...
    -- Inserir a mensagem (sem reply_to_message_id se não existir)
...
BEGIN
    ...
    SELECT
        ...
        m.sent_at,
        m.message_type,
        NULL::UUID as reply_to_message_id, -- Sempre NULL se coluna não existir
        EXISTS (
...
SELECT 'Funções v2 corrigidas com sucesso!' as status;
