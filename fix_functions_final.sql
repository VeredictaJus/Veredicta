...
-- Primeiro, vamos ver quais funções existem (query corrigida)
SELECT r.routine_name, p.data_type, p.parameter_name, p.parameter_mode
FROM information_schema.routines r
LEFT JOIN information_schema.parameters p ON r.specific_name = p.specific_name
WHERE r.routine_name IN ('send_message', 'mark_message_as_read', 'get_conversation_messages')
