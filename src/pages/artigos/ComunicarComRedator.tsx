      ...
      <section className="border-b border-white/10 bg-slate-900/30">
        <div className="container mx-auto px-4 py-10 max-w-screen-2xl">
          ...
          <div className="flex items-center gap-4 mb-5">
            <Badge className="bg-orange-500/15 text-orange-200 border border-orange-500/30">Chat</Badge>
          ...
          <h1 className="text-4xl font-semibold tracking-tight text-white mb-2">Como me comunicar com o redator?</h1>
