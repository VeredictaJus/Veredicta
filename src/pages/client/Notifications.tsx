...
import { Bell, CheckCheck, Filter, Clock, AlertCircle, CheckCircle, FileText, MessageSquare, CreditCard } from 'lucide-react';
import { Avatar, AvatarFallback } from '@/components/ui/avatar';

type FilterType = 'all' | 'plan_expiring_soon' | 'plan_expired' | 'limit_reached' | 'limit_near' | 'petition' | 'message' | 'payment' | 'status';
...
export default function ClientNotifications() {
  ...
  const getTypeName = (type: string) => {
    switch (type) {
      case 'plan_expiring_soon': return 'Plano Expirando';
      case 'plan_expired': return 'Plano Expirado';
      case 'limit_reached': return 'Limite Atingido';
      case 'limit_near': return 'Limite Próximo';
  ...
  const getNavigationUrl = (notification: any): string | null => {
    ...
    switch (notification.type) {
      ...
      // ===== MENSAGENS (Específico por Conversa) =====
      case 'message':
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <Select value={filterType} onValueChange={(v) => setFilterType(v as FilterType)}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="plan_expiring_soon">Plano Expirando</SelectItem>
                    <SelectItem value="plan_expired">Plano Expirado</SelectItem>
                    <SelectItem value="limit_reached">Limite Atingido</SelectItem>
                    <SelectItem value="limit_near">Limite Próximo</SelectItem>
