-- Script para sincronizar dados entre profiles_v2 e user_profiles
...
-- 2. Verificar dados em profiles_v2
SELECT 
...
-- 3. Sincronizar dados do cliente de profiles_v2 para user_profiles
...
-- 5. Sincronizar TODOS os usuários de profiles_v2 para user_profiles
INSERT INTO user_profiles (
    firebase_uid,
    email,
    role,
