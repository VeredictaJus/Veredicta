-- ========================================
-- ATUALIZAR FUNÇÃO: Adicionar 24h ao Prazo na Reatribuição + Recalcular Badges
-- ========================================
-- Quando uma petição é reatribuída após atraso:
-- 1. Adiciona 24 horas ao prazo
-- 2. Recalcula completed_petitions (badge de Trabalhos)
-- 3. Garante que os badges sempre mostram valores corretos
...
BEGIN
  ...
  -- Verificar se a petição estava aprovada (precisa recalcular completed_petitions)
  ...
  SET
    ...
    status = 'pending',
    deadline = new_deadline,  -- ✅ Adicionar 24h ao prazo
    updated_at = NOW()
...
-- ========================================
-- 3️⃣ VERIFICAR FUNÇÕES ATUALIZADAS
-- ========================================
SELECT 
  proname as funcao,
  CASE 
    WHEN proname = 'apply_late_penalty' THEN '✅ Função de aplicar multa (com +24h no prazo e recálculo de badges)'
